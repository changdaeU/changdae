...
import com.ezen.word.service.WordRegisetService;
...
public class MainClass {
	public static void main(String[] args) {
		...
		String[] values = {
				"C는 1972년 켄톰슨과 데니스 리치가 유닉스 운영 체제에서 사용하기 위해 개발한 프로그래밍 언어이다.",
		...
		WordRegisetService rgt = ctx.getBean("registerService", WordRegisetService.class);
