...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		String[] sMajors = {"Korean Literature","French Literature","Philosophy","History","Law","Statistics","Computer",
		...
		for(int i = 0 ; i<sNums.length;i++) {
			Student std1 = new Student(sNums[i], sIds[i], sPws[i], sNames[i], sAges[i], sGenders[i], sMajors[i]);
